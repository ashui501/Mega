...
𝘾𝙧𝙚𝙖𝙩𝙤𝙧 : <a href='https://t.me/Naveen_TG'>Naveen-TG</a>
...
Dᴇᴠᴇʟᴏᴘᴇʀ:
- <a href="https://t.me/Naveen_TG">Naveen Tɢ</a></b>"""

    AFK_TXT = """Away From Keyboard :
...
You can even appoint federation admins, so that your trustworthiest admins can ban across all the chats that you want to protect."""
    ...
    AFED_TXT = """Federation Admin Commands
...
- /fpromote: Promote a User to Admin in the Federation.
- /fdemote: Demote a Admin to a normal User from the Federation."""

    OFED_TXT = """ Federation Owner Commands
...
Cᴏᴍᴍᴀɴᴅs Aɴᴅ Usᴀɢᴇ:
/bugs - <code>ᴛᴏ ɢᴇᴛ ᴛʜᴇ ʀᴇᴄᴇɴᴛ ᴇʀʀᴏʀꜱ</code>
...
Nᴀᴍᴇ - {}"""
    ...
    ALRT_TXT = """ʜᴇʟʟᴏ {},
ᴛʜɪꜱ ɪꜱ ɴᴏᴛ ʏᴏᴜʀ ᴍᴏᴠɪᴇ ʀᴇQᴜᴇꜱᴛ , ʀᴇQᴜᴇꜱᴛ ʏᴏᴜʀs..."""

    OLD_ALRT_TXT = """ʜᴇʏ {},
ʏᴏᴜ ᴀʀᴇ ᴜꜱɪɴɢ ᴏɴᴇ ᴏꜰ ᴍʏ ᴏʟᴅ ᴍᴇꜱꜱᴀɢᴇꜱ, 
ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ᴛʜᴇ ʀᴇQᴜᴇꜱᴛ ᴀɢᴀɪɴ."""

    CUDNT_FND = """ɪ ᴄᴏᴜʟᴅɴoᴛ ꜰɪɴᴅ ᴀɴʏᴛʜɪɴɢ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ {}
ᴅɪᴅ ʏᴏᴜ ᴍᴇᴀɴ ᴀɴʏ ᴏɴᴇ ᴏꜰ ᴛʜᴇꜱᴇ?"""

    I_CUDNT = """ʜᴇʟʟᴏ {} ɪ ᴄᴏᴜʟᴅɴoᴛ ꜰɪɴᴅ ᴀɴʏ ᴍᴏᴠɪᴇꜱ ɪɴ ᴛʜᴀᴛ ɴᴀᴍᴇ. 
...
ᴅᴏɴᴛ ᴜꜱᴇ Symbols"""
    ...
    I_CUD_NT = """ɪ ᴄᴏᴜʟᴅɴoᴛ ꜰɪɴᴅ ᴀɴʏ ᴍᴏᴠɪᴇ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ {}.
...
"""
    ...
    IMDB_TEMPLATE_TXT = """
<b>𝙏𝙞𝙩𝙩𝙡𝙚 :<a href={url}>{title}</a>

𝙂𝙚𝙣𝙧𝙚𝙨 : {genres}
𝙍𝙖𝙩𝙞𝙣𝙜𝙨 : <a href={url}/ratings>{rating}</a> / 10 (ʙᴀsᴇᴅ ᴏɴ {votes} ᴜsᴇʀ ʀᴀᴛɪɴɢ.)
...
/plink - <code>Jᴜsᴛ ʟɪᴋᴇ /link, ʙᴜᴛ ᴛʜᴇ ғɪʟᴇ ᴡɪʟʟ ʙᴇ sᴇɴᴅ ᴡɪᴛʜ ғᴏʀᴡᴀʀᴅ ʀᴇsᴛʀɪᴄᴛɪᴏɴ.</code>"""
    ...
    TELEADMIN_TXT = """Admin Features : 

Make it easy to Manage Your Groups and Admins ..

- /promote : Promote a user in a Chat to Admin.
- /demote : Demote a Admin to a User.
...
- /invitelink : Creates a invite link ot the Current Chat.
- /users: list all the users in the chat.
- /zombies : counts the number of deleted account in your Chat."""
